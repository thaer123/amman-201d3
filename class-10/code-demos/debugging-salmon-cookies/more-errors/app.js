...
CookieStand.prototype.createHourlyRateTable = function(){
  ...
  this.tdEl.textContent = this.name;
...
function handleLocationSubmit(event) {
  ...
  // newCookieStand.makeHeaderRow();
  // newCookieStand.createHourlyRateTable();
  // newCookieStand.sumColumns();
  // newCookieStand.cookieSoldArray();
  renderTable();
};
