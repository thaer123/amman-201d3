...
function handleSubmit(event){
  ...
  var formId = document.getElementById('orderForm');
...
function setItem(){
  ...
  localStorage.setItem( 'coffeeOrders', order);
}

//get all drinks
function getItem(){
  var coffeeOrders = localStorage.getItem('coffeeOrders');
  Coffee.drinks = JSON.parse(coffeeOrders);
  renderOrders();
}
